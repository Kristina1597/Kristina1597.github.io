...
export default {
    ...
    surname: 'Filchenko',
    city: 'Antalya',
    introDescription: `Hi, I'm Kristina! A middle frontend developer based in Turkey`,
    position: 'Frontend Developer',
    years: 'years',
    liveIn: 'Live In',
    dateOfBirth: 'Date Of Birth',
    experienceYears: 'years of experience',
    dateOfBirthValue: '30 October 1997',
    experience: 'Experience',
    projectsCount: 'projects',
    companiesCount: 'companies',
    commonDescription: 'In my work, I am always open to learning new technologies, the opportunity to learn ' +
    ...
    navMenuItems: ['About', 'Projects', 'Pet projects'],
    introGotProject: 'Got a project?',
    introLetsTalkButton: `Let's talk`,
    projectsHeader: {
        projects: 'Projects',
        projectsContributedTo: 'i have contributed to',
    },
    ...
    projects: [
        ...
        },
        {
            ...
            responsibilities: ['optimization and expansion of the functionality of the existing code', 'refinement of existing project',
                'development of new functionality', 'writing scripts', 'code refactoring'],
    ...
    portfolio: 'Portfolio',
    petProjectsName: 'my pet projects',
    petProjects: [
        {
            name: 'Charts',
            links: {
